...
func (item *BattledomeItem) GetPercentageProfit(res *DropDataAnalysisResult) (float64, error) {
...
func (item *BattledomeItem) GetDropRate(res *DropDataAnalysisResult) float64 {
